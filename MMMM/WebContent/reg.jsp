...
if(val.match('Email already taken'))
	{
...
<body class="animsition">
	...
	<!-- Title page -->
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('images/conc11.jpg');">
		<h2 class="ltext-105 cl0 txt-center">
			Customer Registration
		</h2>	
			<a href="index.jsp" class="stext-105 cl0 hov-cl0 trans-04">
					Home
					<i class="fa fa-angle-right m-l-9 m-r-10" area-hidden="true"></i>
				</a>
		...
		<div class="container">
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md" style="background: #F0F0F0;">
					<form name="vinform" autocomplete="off" action="process1.jsp" method="post" id="myForm">
						<h4 class="mtext-105 cl2 txt-center p-b-30">
							Customer Registration
						</h4>

						<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" type="text" name="name" placeholder="Customer Name" required>
						</div>

						<div class="m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" type="text" name="email" placeholder="Customer Email" onkeyup="searchInfo()" required>
						 	<span id="mylocation"></span>
						</div>
						
						<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" type="text" name="number" placeholder="Customer Number" required>
						</div>
						
						<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" type="text" name="address" placeholder="Customer Address" required>
						</div>
						
						<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" type="password" name="pwd" placeholder="Customer Password" required>
						</div>
						
						<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" type="password" name="pwd1" placeholder="Confirm Password" required>
						</div>
						
						<div class="bor8 m-b-30">
							<input type="text" value="<%=password %>" name="pass1" id="pass1" readonly>
						</div>
						
						<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" type="text" name="pass2" placeholder="Enter the above text" required>
						</div>
						
						<button class="flex-c-m stext-101 cl0 size-103 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer" id="mySubmit">
							Register
						</button>
					</form>
					<br>
