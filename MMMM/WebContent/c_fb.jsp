...
<body class="animsition">
	...
	<!-- Title page -->
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('images/conc13.jpg');">
		...
		<div class="container">
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md" style="background: #F0F0F0;">
					<form action="c_fb1.jsp" method = "post">
						<h4 class="mtext-105 cl2 txt-center p-b-30">
							Give FeedBack
						</h4>

						<div class="bor8 m-b-30">
							<textarea class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" rows="7" cols="30" name="fb" placeholder="Enter Feedback" required></textarea>
						</div>
