...
if(v_type==null||v_type.trim().equals("")){  
	...
	{ 
		...
		<br><br>
		<table class="table-shopping-cart" style="margin: 0px 130px;">
		<tr class="table_head">
			...
			do{
				...
				%>				
								<tr class="table_row">
									...
									<td class="column-7">
									<a href="vdelete.jsp?v_name=<%=v_name %>">
									...
									<td class="column-8">
									<a href="vupdate.jsp?vn=<%=v_name%>&vadd=<%=v_address%>&vnum=<%=v_number%>&vtype=<%=v_type%>&vcap=<%=v_capacity%>&vamt=<%=amount%>&fn=<%=fileName%>">
										<div class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10">
											Update
										</div>
									</a>
