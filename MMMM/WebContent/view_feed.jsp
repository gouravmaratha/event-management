...
<body class="animsition">
	...
	<!-- Title page -->
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('images/conc8.jpg');">
		...
		<div class="container">
			...
			<%  
				...
				{ 
						...
						do{
							...
							%>				
											<tr style="height: 50px; text-align:center;">
												...
												<td class="column-2"><%= date %></td>
												<td class="column-3"><%= fb%></td>
											</tr>	
							<%
						}while(rs.next());
					%></table>
					...
					%><script>window.alert("No Feedback Found");</script><%
				}
				con.close();
			%>
					</div>
