				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md" style="background: #F0F0F0;">
					<form action="clogin.jsp" method="post">
						...
						<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" type="email" name="email" placeholder="Customer Email" required>
						</div>
						...
						<a href="cforgot.jsp" class="for">Forgot password?</a>
						<style>
							.for{
								position:absolute;
								margin: -35px 300px;
					...
					<br>
					<a href="reg.jsp"><button class="flex-c-m stext-101 cl0 size-103 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer">
						Register
					</button></a>
				</div>
			</div>
