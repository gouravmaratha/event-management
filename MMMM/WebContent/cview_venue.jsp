...
function searchInfo()  
{  
var v_type=document.vinform.v_type.value;   
var url="cview_venue1.jsp?val="+v_type+" ";  
...
if(request.readyState==4){  
	...
	if(val1.match('No Gardens or Place is found'))
		{
		alert("No Gardens or Place is found");
		}  
document.getElementById('amit').innerHTML=val1;  
}  
}  
		...
		<div class="container">
			<div class="flex-w flex-tr">
				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-11-lg " style="background: #F0F0F0;">
					<form name="vinform" autocomplete="off">
						<h4 class="mtext-105 cl2 txt-center p-b-30">
							Search Here..
						</h4>
						<div class="bor8 m-b-30">
							 <select class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" name="v_type" onchange="searchInfo()">
								<option disabled selected>--Select--</option>
								<option name="Marriage">Marriage</option>
								<option name="family">Family Function</option>
								<option name="birthday">Birthday Party</option>
								<option name="anniversary">Anniversary Party</option>
								<option name="farewell">Farewell Party</option>
								<option name="college">College Events</option>
							</select>
						</div>
					</form>
				</div>
