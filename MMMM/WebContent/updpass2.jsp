		...
		<div class="container">
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md" style="background: #F0F0F0;">
					<form action="updpass3.jsp" method="post">
						<h4 class="mtext-105 cl2 txt-center p-b-30">
							Update Password
						</h4>
						
						<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" type="password" name="opwd" placeholder="Old Password" required>
						</div>
						
						<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" type="password" name="npwd1" placeholder="New Password" required>
						</div>
						
						<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" type="password" name="npwd2" placeholder="Confirm Password" required>
						</div>
						
						<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" type="text" name="otpvalue" placeholder="Enter OTP" required>
						</div>
