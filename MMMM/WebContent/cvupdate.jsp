		...
		<div class="container">
			<div class="flex-w flex-tr">
				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-11-lg " style="background: #F0F0F0;">
					<form action="cupdimg.jsp" method="post">
						...
						<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" type="hidden" name="v_type" value="<%=v_type%>">
						</div>
						
						<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" type="text" name="v_address" value="<%=v_address%>">
						</div>
						
						<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" type="text" name="v_number" value="<%=v_number%>">
						</div>
						
						<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" type="text" name="v_capacity" value="<%=v_capacity%>">
						</div>
						
						<div class="bor8 m-b-30">
							<input class="stext-111 cl2 plh3 size-116 p-l-28 p-r-30" type="text" name="amount" value="<%=amount%>">
						</div>
